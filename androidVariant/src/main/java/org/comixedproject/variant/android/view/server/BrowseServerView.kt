                    ...
                    LazyColumn(
                        ...
                        items(contents) { entry ->
                            when (entry.entryType) {
                                ...
                                EntryType.FILE -> FileItemView(
                                    entry,
                                    downloadingState,
                                    onDownloadFile = onDownloadFile
                                )

                                else -> SubdirectoryItemView(
                                    entry,
...
fun BrowseServerView_preview_directories() {
    ...
    VariantTheme {
        BrowseServerView(
            ...
            "",
            "",
            DIRECTORY_LIST.filter { it.entryType == EntryType.SUBDIRECTORY }, emptyList(), false,
...
fun BrowseServerView_preview_files() {
    ...
    VariantTheme {
        BrowseServerView(
            ...
            DIRECTORY_LIST.filter { it.entryType == EntryType.FILE }, emptyList(), false,
            onLoadDirectory = { _, _ -> }, onStopBrowsing = {}, onDownloadFile = { _, _ -> })
    }
}