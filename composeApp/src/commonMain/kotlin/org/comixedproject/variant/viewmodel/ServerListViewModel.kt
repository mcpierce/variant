...
/**
 * <code>ServerListViewModel</code> holds the state for working with the list of servers.
 *
 * @author Darryl L. Pierce
 */
class ServerListViewModel(private val serverRepository: ServerRepository) : BaseViewModel() {
    ...
    fun updateServer(server: Server) {
        serverRepository.updateServer(server, true)
    }
